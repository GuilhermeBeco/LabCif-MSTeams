...
def writeFiles(user, pathArmazenamento, arrayContactos, arrayMensagens, arrayEventCall, dictionaryConversationDetails,
    ...
    idMessage = 1
    dictFiles = {}
    with open(os.path.join(pathArmazenamento, 'Contactos_{}.csv'.format(user)), 'a+', newline='',
    ...
    with open(os.path.join(pathArmazenamento, 'Mensagens_{}.csv'.format(user)), 'a+', newline='',
              encoding="utf-8") as csvfile:
    ...
    with open(os.path.join(pathArmazenamento, 'Files_{}.csv'.format(user)), 'a+', newline='',
              encoding="utf-8") as csvfile:
    ...
    with open(os.path.join(pathArmazenamento, 'EventCall_{}.csv'.format(user)), 'a+', newline='',
              encoding="utf-8") as csvfile:
    ...
    with open(os.path.join(pathArmazenamento, 'Conversations_{}.csv'.format(user)), 'a+', newline='',
              encoding="utf-8") as csvfile:
    ...
    with open(os.path.join(pathArmazenamento, 'CallOneToOne_{}.csv'.format(user)), 'a+', newline='',
              encoding="utf-8") as csvfile:
